...
import 'package:sdsdream_flutter/lojistik/LocalDB/DatabaseHelper.dart';
import 'package:sdsdream_flutter/lojistik/LocalDB/EvraklarDB.dart';
import 'package:sdsdream_flutter/lojistik/datagrid_utils.dart';
...
class PlansizMalKabul extends StatefulWidget {
  @override
  _PlansizMalKabulState createState() => _PlansizMalKabulState();
}

class _PlansizMalKabulState extends State<PlansizMalKabul> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text("Plansız Mal Kabul (T)"),
        centerTitle: true,
                      ...
                      InkWell(
                        ...
                        onTap: () async {
                          ...
                          if (_dataGridController.selectedRows.length == 0) {
                            Fluttertoast.showToast(msg: "Tablodan göndermek istediğiniz evrakları seçiniz",
                                toastLength: Toast.LENGTH_SHORT,
                                gravity: ToastGravity.CENTER,
                                textColor: Colors.white,
                                backgroundColor: Colors.red.shade600,
