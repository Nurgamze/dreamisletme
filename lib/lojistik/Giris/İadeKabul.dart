...
class IadeKabul extends StatefulWidget {
  @override
  _IadeKabulState createState() => _IadeKabulState();
}

class _IadeKabulState extends State<IadeKabul> {
                        ...
                        onTap: () {
                          ...
                          if (secilenRow < 0) {
                            ...
                            Navigator.push(
                                context,
                                MaterialPageRoute(
                                    builder: (context) => SayimEvrak(sayimlarSayfasiGridList[secilenRow - 1].id ?? 0,
