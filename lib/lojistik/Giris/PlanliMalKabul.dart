...
class PlanliMalKabul extends StatefulWidget {
  @override
  _PlanliMalKabulState createState() => _PlanliMalKabulState();
}

class _PlanliMalKabulState extends State<PlanliMalKabul> {
                        ...
                        onTap: () {
                          ...
                          if (secilenRow < 0) {
                            ...
                            Navigator.push(context,
                                MaterialPageRoute( builder: (context) => SayimEvrak(
