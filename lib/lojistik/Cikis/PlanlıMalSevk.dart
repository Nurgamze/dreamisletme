...
import '../Depo/Sayim/SayimEvrakSayfasi.dart';
import '../LocalDB/DatabaseHelper.dart';
import '../LocalDB/EvraklarDB.dart';
import '../datagrid_utils.dart';

class PlanliMalSevk extends StatefulWidget {
  @override
  _PlanliMalSevkState createState() => _PlanliMalSevkState();
}

class _PlanliMalSevkState extends State<PlanliMalSevk> {
                    ...
                    children: [
                      InkWell(
                        ...
                        onTap: () async {
                          ...
                          String depolarData = "";
                          depolar = (await _databaseHelper.depolarGetir2())!.cast<Depolar>();
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            ...
                            Container(
                              ...
                              width: MediaQuery.of(context).size.width / 1.1,
                              child: ElevatedButton(
                                child: Text(context.watch<StateHelper>()
                                    .depoSecinizTitle),
                                onPressed: () {
                                  Picker(
  ...
  List<DataGridRow> _sayimlarRows() {
    ...
    rows = sayimlarSayfasiGridList
      ...
      DataGridCell<String>(columnName: 'basTarihi', value: DateFormat('dd/MM/yyyy HH:mm').format(DateTime.parse(e.basTarihi.toString().replaceAll(' – ', ' ') + ":00"))),
      DataGridCell<String>(columnName: 'sonIslemTarihi', value: DateFormat('dd/MM/yyyy HH:mm').format(DateTime.parse(e.sonIslemTarihi.toString().replaceAll(' – ', ' ') + ":00"))),
    ]))
        .toList();
