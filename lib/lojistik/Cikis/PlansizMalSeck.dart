...
class PlansizMalSevk extends StatefulWidget {
  @override
  _PlansizMalSevkState createState() => _PlansizMalSevkState();
}

class _PlansizMalSevkState extends State<PlansizMalSevk> {
