...
class FireCikis extends StatefulWidget {
  @override
  _FireCikisState createState() => _FireCikisState();
}

class _FireCikisState extends State<FireCikis> {
