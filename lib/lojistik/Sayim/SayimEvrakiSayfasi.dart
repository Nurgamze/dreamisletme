          ...
          Row(
            ...
            children: [
              ...
              Container(
                  ...
                  child: Center(
                    child: Text("Kalem : ${sayimEvrakSayfasiGridList.length}",
                      ...
                      child: SfDataGrid(
                        ...
                        onCellTap: (value) {
                          Future.delayed(Duration(milliseconds: 50), () {
                            ...
                            if (value.rowColumnIndex.rowIndex > 0) {
                              var row = _sayimEvrakStoklarDtaGridController.selectedRow!.getCells();
                              SayimEvrakStoklarDataGrid arananStok = sayimEvrakStoklarGridList.where((e) => e.stokKodu == row[0].value.toString()).first;
                        ...
                        columns: <GridColumn>[
                          dreamColumn(columnName: 'stokKodu', label: "STOK KODU"),
                          dreamColumn(columnName: 'stokAdi', label: "STOK ADI"),
                          dreamColumn(columnName: 'miktar', label: "DEPODAKİ MİKTAR"),
