  ...
  _alinanlariGetir() async {
    ...
    if(response.statusCode == 200){
      ...
      for(var alislar in alislarJson) {
        StokKimlerdenAlinmisGridModel alis = StokKimlerdenAlinmisGridModel(alislar['cariKodu'], alislar['cariAdi'],alislar['temsilci'], DateTime.parse(alislar['tarih'].toString()), alislar['miktar'],alislar['birim'],alislar['birimFiyat'],
