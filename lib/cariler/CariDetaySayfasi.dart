                              ...
                              child: Column(
                                ...
                                children: [
                                  InkWell(
                                    ...
                                    onTap: () {
                                      Clipboard.setData((ClipboardData(text: widget.data.kod.toString())));
                                  ...
                                  InkWell(
                                    ...
                                    onTap: () {
                                      Clipboard.setData((ClipboardData(text: widget.data.unvan.toString())));
                                      Fluttertoast.showToast(
